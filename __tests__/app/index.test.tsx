...
jest.mock("@/components/board/PlaylistBoard", () => ({ __esModule: true, default: () => null }));
jest.mock("@/components/board/ForYouBoard", () => ({ __esModule: true, default: () => null }));
jest.mock("@/components/board/HeroBoard", () => ({ __esModule: true, default: () => null }));
...
jest.mock("@/actions/getSongs", () => ({ __esModule: true, default: jest.fn() }));
